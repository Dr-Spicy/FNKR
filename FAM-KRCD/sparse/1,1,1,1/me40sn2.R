...
if(method.for.Dist == 'D1'){
  ...
  save(opted_tau, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/opted_tau.Rdata')
  save(opted_tau.chosenone, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/opted_tau.chosenone.Rdata')
  save(opted_lbd, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/opted_lbd.Rdata')
  save(opted_lbd.chosenone, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/opted_lbd.chosenone.Rdata')
  save(tune_MSE_all, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/tune_MSE_all.Rdata')
  save(tune_MSE_all.chosenone, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/tune_MSE_all.chosenone.Rdata')
  save(lbd_c_all, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/lbd_c_all.Rdata')
  save(lbd_c_all.chosenone, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/lbd_c_all.chosenone.Rdata')
  save(final_eval, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/final_eval.Rdata')
  save(final_eval.chosenone, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/final_eval.chosen.Rdata')
  save(K_result, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/K_result.Rdata')
  save(K_result.chosenone, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/K_result.chosenone.Rdata')
  save(csm, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/csm.Rdata')
  save(csm.chosenone, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/csm.chosenone.Rdata')
  save(csm.all, file = '~/Functional Kernel Regression/FAM-KRCD/sparse/1,1,1,1/me40sn2/csm.all.Rdata')
