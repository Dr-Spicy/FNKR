...
save(ARMSE, file = '~/Functional Kernel Regression/FAM-comparison/sparse/me40sn8/ARMSE.Rdata')
save(selection.res, file = '~/Functional Kernel Regression/FAM-comparison/sparse/me40sn8/selection.res.Rdata')
