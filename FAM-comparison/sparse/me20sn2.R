...
save(ARMSE, file = '~/Functional Kernel Regression/FAM-comparison/sparse/me20sn2/ARMSE.Rdata')
save(selection.res, file = '~/Functional Kernel Regression/FAM-comparison/sparse/me20sn2/selection.res.Rdata')
