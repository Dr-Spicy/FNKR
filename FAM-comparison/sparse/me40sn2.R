...
save(ARMSE, file = '~/Functional Kernel Regression/FAM-comparison/sparse/me40sn2/ARMSE.Rdata')
save(selection.res, file = '~/Functional Kernel Regression/FAM-comparison/sparse/me40sn2/selection.res.Rdata')
