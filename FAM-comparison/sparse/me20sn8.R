...
save(ARMSE, file = '~/Functional Kernel Regression/FAM-comparison/sparse/me20sn8/ARMSE.Rdata')
save(selection.res, file = '~/Functional Kernel Regression/FAM-comparison/sparse/me20sn8/selection.res.Rdata')
