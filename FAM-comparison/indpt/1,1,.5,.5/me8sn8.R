...
save(ARMSE, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,.5,.5/me8sn8/ARMSE.Rdata')
save(selection.res, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,.5,.5/me8sn8/selection.res.Rdata')
