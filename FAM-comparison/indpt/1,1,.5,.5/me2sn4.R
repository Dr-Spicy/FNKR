...
save(ARMSE, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,.5,.5/me2sn4/ARMSE.Rdata')
save(selection.res, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,.5,.5/me2sn4/selection.res.Rdata')
