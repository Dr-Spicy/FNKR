...
save(ARMSE, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,1,1/me4sn4/ARMSE.Rdata')
save(selection.res, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,1,1/me4sn4/selection.res.Rdata')
