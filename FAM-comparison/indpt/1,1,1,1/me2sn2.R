...
save(ARMSE, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,1,1/me2sn2/ARMSE.Rdata')
save(selection.res, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,1,1/me2sn2/selection.res.Rdata')
