...
save(ARMSE, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,1,1/me8sn4/ARMSE.Rdata')
save(selection.res, file = '~/Functional Kernel Regression/FAM-comparison/indpt/1,1,1,1/me8sn4/selection.res.Rdata')
